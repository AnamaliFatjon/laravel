        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ route('categorie.create') }}" class="btn btn-sm btn-neutral">New</a>
              ...
              <table class="table align-items-center table-dark table-flush">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="budget">Codice</th>
                    <th scope="col" class="sort" data-sort="status">Colore</th>
                  ...
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <span class="name mb-0 text-sm">{{ $value->categoria }}</span>
                        </div>
                      </div>
                    </th>
                    <td class="budget">
                    ...
                    <td>
                      <span class="badge badge-dot mr-4">
                        ...
                        <span class="status">{{ $value->colore }}</span>
                      </span>
                    </td>
                    <td>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('categorie.show',$value->id) }}">Vedi</a>
                          <a class="dropdown-item" href="{{ route('categorie.edit',$value->id) }}">Modifica</a>
